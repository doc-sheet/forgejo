...
test('Quote reply', async ({browser}, workerInfo) => {
  ...
  await expect(editorTextarea).toHaveValue('> ## [](#lorem-ipsum)Lorem Ipsum\n' +
                                           '> \n' +
  ...
  await expect(editorTextarea).toHaveValue('> ## Ipsum\n' +
                                           '> \n' +
  ...
  await expect(editorTextarea).toHaveValue('> **t appealed** that it took _so long_ for this `feature` to be [cre](https://example.com)\n\n');
...
test('Pull quote reply', async ({browser}, workerInfo) => {
  ...
  // Setup, create code comment.
  await page.click('.add-code-comment');
  await editorTextarea.fill('## Lorem Ipsum\nI would like to say that **I am not appealed** that it took _so long_ for this `feature` to be [created](https://example.com).');
  await page.click('.btn-add-single');
  ...
  await expect(editorTextarea).toHaveValue('> ## Lorem Ipsum\n' +
                                           '> \n' +
                                           '> I would like to say that **I am not appealed** that it took _so long_ for this `feature` to be [created](https://example.com).\n\n');
